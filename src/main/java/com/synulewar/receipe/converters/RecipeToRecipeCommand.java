 ...
 */
@Component
public class RecipeToRecipeCommand implements Converter<Recipe, RecepieCommand>{
    ...
    @Nullable
    @Override
    public RecepieCommand convert(Recipe source) {
        if (source == null) {
            return null;
        }

        final RecepieCommand command = new RecepieCommand();
